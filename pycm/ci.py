...
def AUC_SE_calc(AUC: float, P: int, N: int) -> Union[float, str]:
    ...
    :return: AUC standard error or "None"
    """
    try:
        q0 = AUC * (1 - AUC)
        q1 = (AUC / (2 - AUC)) - AUC**2
...
def LR_SE_calc(item1: int, item2: int, item3: int, item4: int) -> Union[float, str]:
    ...
    :return: likelihood ratio standard error or "None"
    """
    try:
...
def kappa_SE_calc(PA: float, PE: float, POP: int) -> Union[float, str]:
    ...
    :return: kappa standard error or "None"
    """
    try:
...
def __CI_class_handler__(cm, param: str, CV: float,
    ...
    :return: dictionary of CI results per class
    """
    result = {}
...
def __CI_overall_handler__(cm, param: str, CV: float,
    ...
    :param CV: critical value
    :param binom_method: binomial confidence interval method
    :return: list of [SE, (CI_down, CI_up)]
    """
    result = []
