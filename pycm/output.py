...
from .params import (
    HTML_DATASET_TYPE_TEMPLATE, RECOMMEND_HTML_MESSAGE, RECOMMEND_HTML_MESSAGE2,
    TABLE_COLOR, DOCUMENT_ADR, DOCUMENT_ADR_ALT, PARAMS_LINK, PARAMS_DESCRIPTION,
    BENCHMARK_LIST, BENCHMARK_COLOR, DEFAULT_BACKGROUND_COLOR,
    RECOMMEND_BACKGROUND_COLOR, OVERVIEW, CAPITALIZE_FILTER
)
...
def html_overall_stat(
    ...
    :param overall_param: overall parameters list for print
...
def html_class_stat(
    ...
    :param digit: scale (number of fraction digits)(default value: 5)
    :param class_param: class parameters list for print
    :param recommended_list: recommended statistics list
    :param alt_link: alternative link for document flag
    :return: HTML string
    """
